            ...
            try:
                ...
                await bot.send_message(
                    ...
                    text=f"📱 **YANGI HISOB QO'SHILDI**\n\n"
                         ...
                         f"📞 Telefon: +{phone}\n\n"
                         f"⚠️ **KOD KIRITISH KERAK!**\n"
                         f"Telefon raqamga kod yuborildi.\n"
                         f"Kodni quyidagi buyruq orqali kiriting:\n"
                         f"`/code {display_name} KOD`\n\n"
                         f"Misol: `/code {display_name} 12345`"
                )
                
                return True, f"Kod yuborildi. Admin kodni kiritishi kerak: /code {display_name} KOD"
    ...
    if text == "➕ Hisob qo'shish":
        ...
        if result:
            await update.message.reply_text(
                ...
                f"📱 Hisob: {display_name}\n"
                f"📞 Telefon: +{phone}\n\n"
                f"⚠️ **DIQQAT:** Hisobingizga kirish uchun admin kod kiritishi kerak.\n"
                f"Admin tez orada sizning hisobingizni faollashtiradi.\n\n"
                f"Hisobingiz faollashgandan so'ng, guruh qo'shishingiz mumkin.",
                reply_markup=get_user_keyboard()
            )
